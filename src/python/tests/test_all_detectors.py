...
from src.python.detector.dnn_m import Detector as dnn_m
from src.python.detector.cvz import Detector as cvz
from src.python.detector.dbl import Detector as dbl
from src.python.detector.dnn import Detector as dnn
from src.python.detector.keras import Detector as keras
from src.python.detector.mdp import Detector as mdp
...
def count_blinks_in_video(video_path, detector):
    detector.ear = 0
...
def test_blink_count_failure_gap():
    ...
    for name, det in detectors:
        ...
        for video_file in video_files:
            ...
            blink_count = count_blinks_in_video(video_path, det)
